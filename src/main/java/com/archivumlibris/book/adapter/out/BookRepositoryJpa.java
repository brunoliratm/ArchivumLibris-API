...
public interface BookRepositoryJpa extends JpaRepository<BookEntity, Long> {
    ...
    Page<BookEntity> findAll(@Param("genre") BookGenre genre, @Param("title") String title, @Param("publisher") String publisher, @Param("author") String author, Pageable pageable);
}
